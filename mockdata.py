...
ondemand_instances = [
    ...
    (   InstanceType(size='m5.xlarge', availability_zone='us-east-1b', tenancy='default', product='Linux/UNIX'), 28),
    ...
    (   InstanceType(size='m5.xlarge', availability_zone='us-east-1c', tenancy='default', product='Linux/UNIX'), 44),
